...
class GetEarthquakesOperation: GroupOperation {
    ...
    private func produceAlert(_ error: NSError) {
        /*
        ...
        let failedReachability = (OperationErrorDomain, OperationErrorCode.conditionFailed, ReachabilityCondition.name as String?)
